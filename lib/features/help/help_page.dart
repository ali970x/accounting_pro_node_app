...
const _arabicSteps = [
  ...
  _GuideStep("نفّذ المبيع بسرعة", "من صفحة المبيع اختر الصنف ثم التصنيف الفرعي، وبعدها ابحث عن المنتج أو النوعية. الاقتراحات تظهر فقط من التصنيف المحدد حتى توصل للمنتج بسرعة."),
  _GuideStep("سجّل البضاعة التالفة", "من صفحة البضاعة التالفة اختر الصنف والتصنيف الفرعي، ابحث عن المنتج، أدخل الكمية التالفة وقيمة الخسارة. يمكن تصفير سجل التالف وإرجاع الكميات للمخزون عند الحاجة."),
  ...
  _GuideStep("فلتر السجلات والديون", "في السجلات والديون استخدم خيارات يوم، أسبوع، شهر، أو تاريخ مخصص لعرض الفترة التي تريدها فقط."),
