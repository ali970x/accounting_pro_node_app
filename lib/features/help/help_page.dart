    ...
    return ListView(
      ...
      children: [
        ...
        ModernCard(
          ...
          child: Text(
            isAr
                ? "ابدأ بهذه الخطوات بالترتيب حتى يصير التطبيق جاهز للمحل بدون مساعدة."
                : "Follow these steps in order to get the shop workflow running without help.",
...
const _arabicSteps = [
  ...
  _GuideStep("ابنِ المخزون", "من المخزون أضف التصنيف، التصنيف الفرعي، ونوعية الصنف. مثال: بطاطا > بطاطا حلوة > فئة أولى."),
  _GuideStep("ورّد الكمية من المورد", "افتح الصنف واضغط توريد كمية. اختر المورد، الكمية، سعر الشراء، والعملة. إذا بقي الحساب دين فعل خيار الدين."),
  _GuideStep("نفّذ المبيع", "من صفحة المبيع اكتب اسم الزبون للبحث، اختر الصنف والكمية والسعر. إذا لم يدفع الزبون فعل تسجيل الفاتورة كدين."),
  _GuideStep("سجّل المصاريف", "أي مصروف للمحل سجله من صفحة المصاريف مع العملة الصحيحة حتى يظهر في صافي الربح."),
  _GuideStep("راجع الديون", "صفحة الديون تجمع ديون الزباين والموردين حسب العملة. افتح الشخص لتشاهد الفواتير والدفعات."),
  _GuideStep("تابع التقارير", "التقارير تعرض المبيعات، المصاريف، الربح، والديون. كبسة طويلة على صافي الربح تعرض الربح الفعلي بعد الديون."),
...
const _englishSteps = [
  ...
  _GuideStep("Create sales", "Search the customer while typing, choose item, quantity, and price. Mark as debt only when unpaid."),
  ...
  _GuideStep("Use reports", "Reports show sales, expenses, profit, and debts. Long-press net profit to see actual profit after debts."),
